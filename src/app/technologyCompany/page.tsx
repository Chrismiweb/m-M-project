// technologyCompany.js
import React from "react";
import { FaGreaterThan } from "react-icons/fa6";

export default function TechnologyCompany() {
    const companylist = [
        {
            logo: "Logo will be here ",
            companyName: "Technology Company Name 1"
        },
        {
            logo: "Logo will be here",
            companyName: "Technology Company Name 2"
        },
        {
            logo: "Logo will be here",
            companyName: "Technology Company Name 2"
    ...
    return (
        <div className="w-[100%] bg-blue-100 py-[100px]">
            <div className="w-[100%] bg-blue-100 flex flex-col justify-center items-center gap-[30px]">
                <h2 className="text-[24px] font-bold">Technology Companies</h2>
