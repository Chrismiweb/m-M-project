...
">
            <div className="w-[80%] items-center justify-center flex flex-col gap-[20px] md:w-[50%]">
              ...
              <h1 className="text-center font-bold text-[30px] font-mono text-white md:text-[45px]">We Provide Company Info, Marketing, And Sales Hub.</h1>
              ...
              <button className='text-white bg-blue-500 font-mono font-semibold transition-all duration-500 hover:bg-blue-700 rounded-[5px] py-[13px] px-[20px]'>Discover More</button>
            </div>
