...
export default function footer(){
    return(
        <footer className="w-[100%] bg-white md:items-start py-[70px] md:px-[50px] gap-[30px] justify-center items-center flex flex-col ">
            ...
            <div className="w-[100%] gap-[30px] md:flex-row justify-center flex flex-col items-center">
                <div className=" font-semibold md:flex-row md:justify-start md:items-start text-[16px] justify-center gap-3 items-center flex flex-col text-center w-[100%]">
                    <div className="flex flex-col w-[90%] gap-3 justify-center items-center md:justify-start md:items-start">
            ...
            <div className='flex gap-4 w-[100%] justify-center items-center md:text-[20px] '>
                    <FaFacebookF/>
                    <FaLinkedin/>
                    <FaTwitter/>
                    <FaYoutube/>
