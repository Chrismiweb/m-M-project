...
export default function bgtest(){
    ...
    return(
        <div className="blog1cont font-mono relative w-full overflow-hidden">
            ...
            <div className='relative z-10 flex gap-[50px] flex-col items-center justify-center h-full text-white'>
